...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg">{{trans('messages.empresa')}}</span>
    </a>
...
{{--                <!-- Tasks Menu -->
                ...
                @else
                    ...
                    <li class="dropdown user user-menu" id="user_menu" style="max-width: 280px;white-space: nowrap;">
                        <!-- Menu Toggle Button -->
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="max-width: 280px;max-height: 50px;white-space: nowrap;overflow: hidden;overflow-text: ellipsis">
